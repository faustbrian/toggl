...
describe('InvalidPrimaryKeyValueException', function (): void {
    describe('nonStringUuid', function (): void {
        describe('Happy Path', function (): void {
            test('creates exception with integer value', function (): void {
                ...
                // Act
                $exception = NonStringUuidPrimaryKeyException::forValue($value);

                // Assert
                expect($exception)->toBeInstanceOf(NonStringUuidPrimaryKeyException::class);
    ...
    describe('nonStringUlid', function (): void {
        describe('Happy Path', function (): void {
            test('creates exception with integer value', function (): void {
                ...
                // Act
                $exception = NonStringUlidPrimaryKeyException::forValue($value);

                // Assert
                expect($exception)->toBeInstanceOf(NonStringUlidPrimaryKeyException::class);
                expect($exception)->toBeInstanceOf(InvalidArgumentException::class);
                expect($exception->getMessage())
    ...
    describe('Inheritance', function (): void {
        test('both methods return instances that extend InvalidArgumentException', function (): void {
            // Arrange & Act
            $uuidException = NonStringUuidPrimaryKeyException::forValue(123);
            $ulidException = NonStringUlidPrimaryKeyException::forValue(456);
    ...
    describe('Message Format', function (): void {
        ...
        test('messages differ between UUID and ULID variants', function (): void {
            // Arrange & Act
            $uuidException = NonStringUuidPrimaryKeyException::forValue(123);
            $ulidException = NonStringUlidPrimaryKeyException::forValue(123);
