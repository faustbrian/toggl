...
describe('GateDriver', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('gets feature value through gate', function (): void {
            // Arrange
            app(Gate::class)->define('feature', fn ($user, $feature): bool => $feature === 'admin-feature');
        ...
        test('evaluates gate for different users', function (): void {
            // Arrange
            app(Gate::class)->define('feature', fn ($user, $feature): bool => $user->id === 1 && $feature === 'premium-feature');
        ...
        test('getAll properly executes nested map closures for multiple features and contexts', function (): void {
            ...
            app(Gate::class)->define('feature', function ($user, $feature) use (&$innerClosureCalls): bool {
        ...
        test('uses custom gate name from configuration', function (): void {
            ...
            app(Gate::class)->define('custom-gate', fn ($user, $feature): bool => $feature === 'test-feature');
    ...
    describe('Edge Cases', function (): void {
        test('handles TogglContext without source falling back to context', function (): void {
            ...
            app(Gate::class)->define('feature', fn (mixed $user, $feature): bool => $feature === 'public-feature');
        ...
        test('handles empty getAll request', function (): void {
            // Arrange
            app(Gate::class)->define('feature', fn (): true => true);
            $driver = createGateDriver();
        ...
        test('handles multiple contexts for same feature in getAll', function (): void {
            // Arrange
            app(Gate::class)->define('feature', fn ($user, $feature): bool => $user->id === 1);
        ...
        test('gate receives correct feature name parameter', function (): void {
            ...
            app(Gate::class)->define('feature', function ($user, $feature) use (&$receivedFeature): true {
        ...
        test('gate always returns boolean result', function (): void {
            // Arrange
            app(Gate::class)->define('feature', fn (): string => 'string-value');
        ...
        test('evaluates gate in real-time without caching', function (): void {
            // Arrange
            $callCount = 0;
            app(Gate::class)->define('feature', function ($user, $feature) use (&$callCount): true {
                ++$callCount;
