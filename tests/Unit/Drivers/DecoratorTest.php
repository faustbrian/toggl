...
describe('Decorator', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('activateGroupForEveryone activates all features in group', function (): void {
            ...
            // Assert
            expect($decorator->get('feature1', TogglContext::simple('user1', 'test'))->toValue())->toBeTrue();
            expect($decorator->get('feature2', TogglContext::simple('user1', 'test'))->toValue())->toBeTrue();
        });
        ...
        test('deactivateGroupForEveryone deactivates all features in group', function (): void {
            ...
            // Assert
            expect($decorator->get('feature1', TogglContext::simple('user1', 'test'))->toValue())->toBeFalse();
            expect($decorator->get('feature2', TogglContext::simple('user1', 'test'))->toValue())->toBeFalse();
        });
        ...
        test('resolve handles invokable objects like Laravel Lottery', function (): void {
            ...
            // Assert
            expect($result->toValue())->toBeTrue(); // Line 976-977
        });
        ...
        test('resolves TogglContextable to identifier', function (): void {
            ...
            // Assert
            expect($result->toValue())->toBeTrue(); // Line 1081
        });
        ...
        test('circular dependency detection prevents infinite recursion', function (): void {
            ...
            expect($result->toValue())->toBeFalse(); // Line 956, 1013
        });
        ...
        test('expired feature returns false during get', function (): void {
            ...
            // Assert
            expect($result->toValue())->toBeFalse(); // Line 828
        ...
        test('define with class auto-discovery and resolve method', function (): void {
            ...
            expect($decorator->get('test-feature-resolve', TogglContext::simple('user1', 'test'))->toValue())->toBe('resolved-value'); // Line 162-174
        });
        ...
        test('define with class auto-discovery and __invoke method', function (): void {
            ...
            expect($decorator->get('test-feature', TogglContext::simple('user1', 'test'))->toValue())->toBe('invoked-value'); // Line 167-171
        });
        ...
        test('setContainer updates container instance', function (): void {
            // Arrange
            $decorator = createDecorator();
            $newContainer = resolve(Container::class);
        ...
        test('dynamic feature definition when checking undefined class-based feature', function (): void {
            ...
            expect($result->toValue())->toBe('invoked-value');
        });
    });
    ...
    describe('Edge Cases', function (): void {
        ...
        test('define with LazilyResolvedFeature instance', function (): void {
            ...
            // Assert
            expect($decorator->defined())->toContain('test-feature');
            expect($decorator->get('test-feature', TogglContext::simple('user1', 'test'))->toValue())->toBe('value'); // Line 186-193
        });
        ...
        test('define with static value', function (): void {
            ...
            // Assert
            expect($decorator->get('test-feature', TogglContext::simple('user1', 'test'))->toBool())->toBeTrue(); // Line 200-204
        });
        ...
        test('__call with defaultContextResolver returning non-null value', function (): void {
            ...
            $decorator = new Decorator(
                'test',
                new ArrayDriver(resolve(Dispatcher::class), []),
        ...
        test('normalizeFeaturesToLoad with associative array keys', function (): void {
            ...
            expect(array_map(fn ($s) => $s->toValue(), $results['feature1']))->toContain('value-for-context1');
            expect(array_map(fn ($s) => $s->toValue(), $results['feature2']))->toContain('value-for-context2');
            expect(array_map(fn ($s) => $s->toValue(), $results['feature2']))->toContain('value-for-context3');
        });
        ...
        test('ensureDynamicFeatureIsDefined with class without name property', function (): void {
            ...
            expect($result->toValue())->toBe('no-name-value');
        });
        ...
        test('checkFeatureViaFeatureGroupMembership handles exception when group does not exist', function (): void {
            ...
            expect($result->toValue())->toBeTrue(); // Returns feature's default value // Lines 1040-1053
        });
        ...
        test('checkFeatureViaFeatureGroupMembership returns group value when feature is in group', function (): void {
            ...
            expect($result->toValue())->toBeTrue(); // Lines 1040-1050
        });
        ...
        test('checkFeatureViaFeatureGroupMembership continues on exception and checks remaining groups', function (): void {
            ...
            expect($result->toValue())->toBeTrue(); // Lines 1051-1054
        });
        ...
        test('assign and unassign feature group membership integration', function (): void {
            ...
            // Assert
            expect($resultAfterAdd->toBool())->toBeTrue(); // Feature active via set()
            expect($resultAfterRemove->toBool())->toBeFalse(); // Feature returns resolver's false after cache flush
        });
        ...
        test('putInCache updates existing entry when feature/context match', function (): void {
            ...
            expect($firstGet->toValue())->toBe(1);
            expect($secondGet->toValue())->toBe(999); // Line 1261: cache update path
        ...
        test('checkFeatureViaFeatureGroupMembership returns false when group value is false', function (): void {
            ...
            expect($result->toValue())->toBeFalse(); // Line 1047: false check
        });
        ...
        test('enableGlobally activates feature for everyone', function (): void {
            ...
            // Assert
            expect($decorator->get('premium-feature', TogglContext::simple('user1', 'test'))->toBool())->toBeTrue();
            expect($decorator->get('premium-feature', TogglContext::simple('user2', 'test'))->toBool())->toBeTrue(); // Line 483
        });
        ...
        test('disableGlobally deactivates feature for everyone', function (): void {
            ...
            // Assert
            expect($decorator->get('test-feature', TogglContext::simple('user1', 'test'))->toBool())->toBeFalse();
            expect($decorator->get('test-feature', TogglContext::simple('user2', 'test'))->toBool())->toBeFalse(); // Line 493
        });
        ...
        test('define with class having no resolve method but callable via __invoke', function (): void {
            ...
            expect($decorator->get('test-feature', TogglContext::simple('user1', 'test'))->toValue())->toBe('invoked-value');
        });
        ...
        test('define with LazilyResolvedFeature passes through to driver', function (): void {
            ...
            // Assert
            expect($decorator->get('lazy-feature', TogglContext::simple('user1', 'test'))->toValue())->toBe('lazy-value');
        });
        ...
        test('define with non-closure resolver wraps value', function (): void {
            ...
            // Assert
            expect($decorator->get('static-feature', TogglContext::simple('user1', 'test'))->toValue())->toBe('static-value');
        });
        ...
        test('setForAllContexts clears cache via reject', function (): void {
            ...
            expect($result->toValue())->toBe(999);
        ...
        test('putInCache adds new entry when position is false', function (): void {
            ...
            expect($result->toValue())->toBe('new-value');
            expect($result2->toValue())->toBe('new-value');
        });
        ...
        test('putInCache updates existing entry at position', function (): void {
            ...
            // Assert
            expect($initial->toValue())->toBe('initial');
            expect($result->toValue())->toBe('updated');
        });
        ...
        test('dispatchFeatureEvent dispatches FeatureDeactivated on false value', function (): void {
            ...
            resolve(Dispatcher::class)->listen(FeatureDeactivated::class, function () use (&$eventDispatched): void {
        ...
        test('dispatchFeatureEvent dispatches FeatureActivated on non-false value', function (): void {
            ...
            $eventDispatched = false;
            resolve(Dispatcher::class)->listen(FeatureActivated::class, function () use (&$eventDispatched): void {
                $eventDispatched = true;
            });
        ...
        test('checkFeatureViaFeatureGroupMembership returns false when group value is null', function (): void {
            ...
            expect($result->toValue())->toBeFalse();
        });
        ...
        test('resolve with resolver accepting two parameters passes global context', function (): void {
            ...
            expect($result->toValue())->toBeTrue();
        ...
        test('setForAllContexts executes cache reject branch', function (): void {
            ...
            expect($result1->toValue())->toBe('global-value');
            expect($result2->toValue())->toBe('global-value');
            expect($result3->toValue())->toBe('global-value');
        });
        ...
        test('putInCache search lambda is executed on cache update', function (): void {
            ...
            expect($initialValue->toValue())->toBe('initial');
            expect($updatedValue->toValue())->toBe('updated');
        });
        ...
        test('define with resolve method uses instance resolve', function (): void {
            ...
            expect($result->toValue())->toBe('resolved-value');
        });
        ...
        test('define with LazilyResolvedFeature uses getResolver', function (): void {
            ...
            expect($result->toValue())->toBe('lazy-result');
        });
        ...
        test('define with non-Closure wraps in lambda', function (): void {
            ...
            expect($result->toValue())->toBe('static-string-value');
        });
        ...
        test('isCached uses global context serialization from FeatureManager', function (): void {
            ...
            expect($result->toValue())->toBe('value');
        ...
        test('putInCache uses global context serialization from FeatureManager', function (): void {
            ...
            expect($initial->toValue())->toBe('initial');
            expect($updated->toValue())->toBe('updated');
        });
        ...
        test('define with LazilyResolvedFeature calls getResolver and resolves', function (): void {
            ...
            expect($result->toValue())->toBe('lazy-value');
        });
        ...
        test('define with non-closure resolver wraps value in callable', function (): void {
            ...
            expect($result->toValue())->toBe('static-value');
        });
        ...
        test('putInCache updates existing cache entry at specific position', function (): void {
            ...
            expect($original->toValue())->toBe('original');
            expect($modified->toValue())->toBe('modified');
        });
        ...
        test('isCached correctly identifies cached features with global context', function (): void {
            ...
            expect($first->toValue())->toBe('value-1');
            expect($second->toValue())->toBe('value-1');
