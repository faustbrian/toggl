...
use BackedEnum;
use Cline\Toggl\Exceptions\StrategyDataMustBeArrayException;
use Cline\Toggl\Exceptions\StrategyDataMustBeIntegerException;
...
final readonly class StrategyConductor
{
    ...
    {
        throw_unless(is_int($this->strategyData), StrategyDataMustBeIntegerException::create());
    ...
    {
        throw_unless(is_array($this->strategyData), StrategyDataMustBeArrayException::forStrategy('time'));
    ...
    {
        throw_unless(is_array($this->strategyData), StrategyDataMustBeArrayException::forStrategy('variants'));
