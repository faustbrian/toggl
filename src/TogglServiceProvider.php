...
final class TogglServiceProvider extends PackageServiceProvider
{
    ...
    /**
     * Register Toggl models with the VariableKeys service.
     *
     * Configures primary key types for all Toggl database models based on
     * the configured primary_key_type setting (id, uuid, or ulid).
     */
    private function registerVariableKeyModels(): void
    {
        ...
        VariableKeys::map([
            ...
            FeatureGroupMembership::class => [
                'primary_key_type' => $primaryKeyType,
            ],
            FeatureSnapshot::class => [
                'primary_key_type' => $primaryKeyType,
            ],
            FeatureSnapshotEntry::class => [
                'primary_key_type' => $primaryKeyType,
            ],
            FeatureSnapshotEvent::class => [
                'primary_key_type' => $primaryKeyType,
            ],
        ]);
    }
