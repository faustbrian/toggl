...
use Cline\Toggl\Exceptions\EmptyVariantWeightsException;
...
final class FeatureManager
{
    ...
    {
        $driver = $this->container->make(DatabaseDriver::class, [
            'name' => $name,
    ...
    public function calculateVariant(string $feature, mixed $context, array $weights): string
    {
        ...
        throw_if($lastKey === null, EmptyVariantWeightsException::create());
