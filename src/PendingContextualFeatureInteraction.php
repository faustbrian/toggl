...
use Cline\Toggl\Exceptions\CannotRetrieveValuesForMultipleContextsException;
use Cline\Toggl\Exceptions\CannotRetrieveVariantsForMultipleContextsException;
...
final class PendingContextualFeatureInteraction
{
    ...
    {
        throw_if(count($this->getContexts()) > 1, CannotRetrieveVariantsForMultipleContextsException::create());
