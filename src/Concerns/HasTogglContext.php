...
trait HasTogglContext
{
     ...
     * implementation uses getMorphClass() for Model instances to respect Laravel's
     * morphMap configuration, falling back to lowercase class basename for non-Model
     * classes.
     *
