    ...
    private function createMigrator(string $name, Driver $driver): ?Migrator
    {
        return match ($name) {
            'pennant' => new PennantMigrator(
                ...
                migrationTracking: Config::boolean('toggl.migrators.pennant.migration_tracking.enabled', false),
            ...
            'ylsideas' => new YLSIdeasMigrator(
                ...
                migrationTracking: Config::boolean('toggl.migrators.ylsideas.migration_tracking.enabled', false),
